...
class DataProcessor:
    def __init__(self, output_graph, valid_color_name, error_color_name,
                 do_filtering, filter_freq, filter_roughness, do_inversion):
        """
        ...
        self.inversion_flag = do_inversion
        ...
        # skip data if busy
            ...
            if len(line) > 0:
                try:
                    ...
                    #data inversion
                    if self.inversion_flag:
                        y = settings.DATA_MAX_VALUE - y
            ...
            self.busy_flag = False
    def set_filtering(self, allow_filter):
        # allow_filter : True - use filter
        #                False - do not use filter
        self.filtering_flag = allow_filter
    def set_inversion(self, allow_inversion):
        # allow_inversion : True - invert signal
        self.inversion_flag = allow_inversion
